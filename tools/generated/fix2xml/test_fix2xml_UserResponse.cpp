...
TEST ( UserResponse, set_fields)
{
  ...
  set_field(msg, FIX::UserRequestID{"STRING_189856350"}, UserResponse_0);
  set_field(msg, FIX::UserStatus{1}, UserResponse_0);
  set_field(msg, FIX::UserStatusText{"STRING_1705387247"}, UserResponse_0);
  set_field(msg, FIX::Username{"STRING_583343540"}, UserResponse_0);
