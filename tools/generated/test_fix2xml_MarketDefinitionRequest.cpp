...
TEST ( MarketDefinitionRequest, set_fields)
{
  ...
  set_field(msg, FIX::MarketID{"EXCHANGE_2038154284"}, MarketDefinitionRequest_0);
  set_field(msg, FIX::MarketReqID{"STRING_1504676712"}, MarketDefinitionRequest_0);
  set_field(msg, FIX::MarketSegmentID{"STRING_225278210"}, MarketDefinitionRequest_0);
  set_field(msg, FIX::ParentMktSegmID{"STRING_1465345319"}, MarketDefinitionRequest_0);
